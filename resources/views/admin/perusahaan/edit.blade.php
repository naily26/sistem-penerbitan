                    ...
                    <div class="panel-body">
                        <form method="post" action="#" class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    <select class="form-control" id="country" name="status-tahap-1" onchange="showDiv('petugas-form',this)">
                                        <option value="">&nbsp;</option>
                            ...
                            <div id="petugas-form" class="form-group">
                                <label class="col-sm-3 control-label">
...
<script>
    function showDiv(divId, element) {
        document.getElementById(divId).style.display = element.value == 'lengkap' ? 'block' : 'none';
    }
