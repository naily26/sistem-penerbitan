                        ...
                        <table class="table table-striped table-bordered table-hover table-full-width" id="sample_1">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-xs btn-success" href="#"><i class="fa fa-eye"></i> detail</a>
                                    </td>
                                </tr>
                                <tr>
                                    <td>AOL Explorer</td>
                                    ...
                                    <td>
                                        <a class="btn btn-xs btn-warning" href="{{route('perusahaan.edit', 1)}}"><i
                                                class="fa fa-edit"></i>
                                            edit</a>
                                        <a href="#hapus-data" class="btn btn-danger btn-xs" data-toggle="modal"><i
                                                class="fa fa-trash-o"></i>
                                            hapus</a>
                                        <a class="btn btn-xs btn-success" href="{{route('perusahaan.show', 1)}}"><i
